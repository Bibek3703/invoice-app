...
function Vendors({ userId, companyId }: { userId: string, companyId: string }) {
    ...
    const { data: contacts, isLoading, isFetching } = useVendors(companyId, {
    ...
    return (
        <div className='flex-1 h-full w-full' >
            <DataTable
                ...
                emptyTitle='No Vendor Yet'
                emptyDescription="You haven't created any vendor yet. Get started by creating your first vendor."
