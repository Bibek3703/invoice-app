...
import { useAllContacts } from '@/hooks/use-contacts';
import { contactColumns, contactSchema } from './columns/contacts';

function Contacts({ userId, companyId }: { userId: string, companyId: string }) {
    ...
    const { data: contacts, isLoading, isFetching } = useAllContacts(companyId, {
    ...
    return (
        <div className='flex-1 h-full w-full'>
            <DataTable
                ...
                emptyTitle='No Contact Yet'
                emptyDescription="You haven't created any contact yet. Get started by creating your first contact."
